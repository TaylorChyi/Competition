...
out=Path('lab/survival/iteration02/gamma');parent=Path('lab/survival/iteration01/combined');opponent=Path('lab/tournament/round05/alpha')
allrows=[]
for label,path in [('parent',parent),('batch_sales',out)]:
