...
from lab.survival.iteration06.alpha.brain import decide as rocket
...
out={}
for name,policy in (('rejected_rocket',rocket),('champion',parent)):
...
Path('lab/survival/iteration07/alpha/revealed-counterfactual.json').write_text(json.dumps(out,indent=2))
