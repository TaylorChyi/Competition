...
out=Path('lab/survival/iteration03/gamma');parent=Path('lab/tournament/round05/alpha');opponent=Path('lab/tournament/round05/alpha')
allrows=[]
for label,path in [('nearest_guard',out)]:
 for seed,priority in [(22000,'nearest'),(22001,'nearest'),(22002,'nearest')]:
  for seat in TEAMS:
