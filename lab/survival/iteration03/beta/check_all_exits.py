from .full_ring_exits.brain import _wall_order,_tower_sites
from .full_ring_exits.protocol import Turn,Pos
from .full_ring_exits.grid import shortest_path
...
for bx,by,rx,ry in [(9,22,10,20),(30,10,30,11)]:
 ...
 assert len(walls)==len(set(walls))==18
 ...
 print('base',bx,by,'18 walls, every free inner-ring cell can exit')
