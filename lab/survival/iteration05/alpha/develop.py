...
from lab.survival.iteration05.alpha.rejected_balanced.brain import decide
from lab.survival.iteration05.alpha.rejected_balanced.protocol import Turn,Pos
from lab.survival.iteration05.alpha.rejected_balanced.fire_control import ray_hits
from lab.survival.iteration05.alpha.rejected_balanced.targeting import splash_damage
...
for seed in (36007,36002,22000,22001,22002,26006):
 for seat in (('challenger',) if seed in (36007,36002) else ('challenger','defender')):
...
Path('lab/survival/iteration05/alpha/balanced-upgrades.json').write_text(json.dumps(out,indent=2))
