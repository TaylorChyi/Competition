...
from lab.survival.iteration08.alpha.brain import decide
from lab.survival.iteration08.alpha.protocol import Turn,Pos
from lab.survival.iteration08.alpha.fire_control import ray_hits
from lab.survival.iteration08.alpha.targeting import splash_damage
...
for seed in (22000,22001,22002,26006,36002,36007,46003,36004,36008):
 for seat in (('defender',) if seed in (46003,36004) else ('challenger',) if seed in (36002,36007,36008) else ('challenger','defender')):
...
Path('lab/survival/iteration08/alpha/front_voucher_first.json').write_text(json.dumps(out,indent=2))
