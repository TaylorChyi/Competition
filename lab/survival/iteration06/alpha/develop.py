...
from lab.survival.iteration06.alpha.protocol import Turn,Pos
from lab.survival.iteration06.alpha.fire_control import ray_hits
from lab.survival.iteration06.alpha.targeting import splash_damage
...
for seed in (22000,22001,22002,26006,36002,36007):
 for seat in (('challenger',) if seed in (36002,36007) else ('challenger','defender')):
...
Path('lab/survival/iteration06/alpha/partial12-rocket.json').write_text(json.dumps(out,indent=2))
