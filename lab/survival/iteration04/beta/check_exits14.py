from .partial14.brain import _wall_order,_tower_sites
from .partial14.protocol import Turn,Pos
from .partial14.grid import shortest_path
...
for bx,by,rx,ry in [(9,22,10,20),(30,10,30,11)]:
 ...
 assert len(walls)==len(set(walls))==14
 ...
 print('base',bx,by,'14 walls, every free inner-ring cell can exit')
