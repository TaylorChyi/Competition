...
for label,package in [('partial14','lab.survival.iteration04.beta.partial14'),('partial12','lab.survival.iteration04.beta.partial12')]:
  ...
  for seat in (0,1):
   ...
   class ObservedArena(Arena):
    def settle(self,commands):
     ...
     if len(walls)==(14 if label=='partial14' else 12) and full_round is None:full_round=self.number
