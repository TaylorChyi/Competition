...
from lab.survival.iteration04.alpha.protocol import Turn,Pos
from lab.survival.iteration04.alpha.fire_control import ray_hits
from lab.survival.iteration04.alpha.targeting import splash_damage
...
Path('lab/survival/iteration04/alpha/rear-rocket.json').write_text(json.dumps(out,indent=2))
