...
from lab.tournament.round06.gamma.brain import decide
from lab.tournament.round05.alpha.brain import decide as champion
rows=[]
...
open('lab/tournament/round06/gamma/development.json','w').write(json.dumps(rows,indent=2))
