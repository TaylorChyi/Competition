...
from lab.tournament.round05.gamma.brain import decide
from lab.tournament.round04.gamma.brain import decide as champion
rows=[]
for seed,priority in [(22001,'operators'),(22002,'advance'),(28002,'advance')]:
...
open('lab/tournament/round05/gamma/development.json','w').write(json.dumps(rows,indent=2))
