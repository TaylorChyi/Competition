...
out=Path('lab/tournament/round07/gamma');parent=Path('lab/survival/iteration03/beta/full_ring_exits');opponent=Path('lab/tournament/round05/alpha')
allrows=[]
for label,path in [('parent',parent),('nearest_guard',out)]:
