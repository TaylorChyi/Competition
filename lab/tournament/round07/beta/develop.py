...
for label,package in [('parent','lab.tournament.round07.beta.parent'),('batch10','lab.tournament.round07.beta.batch10'),('after_screen','lab.tournament.round07.beta.after_screen')]:
  ...
  for seat in (0,1):
   ...
   class ObservedArena(Arena):
    def settle(self,commands):
     ...
     if len(walls)==18 and full_round is None:full_round=self.number
