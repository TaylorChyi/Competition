...
- 三炮建好后，一名工人逐步补18块围墙并留两个出口，另一名工人继续采矿。先补缺口，再维护残墙；金币留给基地急救和炮台升级，没有新增常规墙升级采购。
...
用户已确认机器人每回合只能移动或攻击，目标为最近或挡路单位。本版采用18墙双出口：开发8/8、独立验证20/20全部活到第1300回合，零非法动作；两侧所有空闲内侧炮手站位均有出路。相比同6场的四墙4/6、顺手建墙实际零墙0/6，这一结构改善了生存，但炮台升级会更慢。完整结果与取舍见[十晚生存门槛](docs/十晚生存门槛.md)。100%只覆盖本地验收集，正式平台仍需复测。
