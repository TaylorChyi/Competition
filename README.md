...
- 两座前排电磁炮、一座侧后火箭炮，按基地朝向布置并留出操作位；只给攻击我方的机器人评分。一级武器券优先交给前排电磁炮，夜间仍只在邻格合法使用。
- 火箭先按范围收益选点，电磁炮参考已预留伤害联合分配目标；只有伤害不降且预计多击杀时才调整电磁炮顺序。操作员高风险时避险，日落前调整后排站位。
...
### 最新：第10轮冠军，20/20组获胜并活满十晚

本版保留12块关键方向围墙，采用两前排电磁炮＋侧后火箭炮。一级武器券先保障前排持续输出，再发展后排火箭；急救基地和持券立即用的规则保留。候选先通过原8+20回归和全新20场十晚验证，第10轮对另外两版各10组换边赛，20/20组获胜、40/40半场活满十晚，零非法动作。单个半场是38胜2负；100%指预定的换边组胜率，不能写成每个半场或官方比赛必胜。

两位败者已精确继承冠军。完整赛果与失败版本见[锦标赛进度](docs/锦标赛进度.md)。[围墙与火力对照](docs/十晚生存门槛.md)支持减少低贡献后墙；墙升级券仅20/30金币，目前未做墙券开关对照，不能概括为所有墙升级都劣于炮升级。
