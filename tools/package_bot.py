...
FILES = [
    ...
    ('CoreGeek/src/agent/fire_control.py', 'src/agent/fire_control.py'),
    ('CoreGeek/src/agent/economy.py', 'src/agent/economy.py'),
    ('CoreGeek/src/agent/guard.py', 'src/agent/guard.py'),
