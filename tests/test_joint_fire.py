"""Regression for leaving a constrained gun idle despite two killable targets."""
from pathlib import Path
import sys
sys.path.insert(0,str(Path(__file__).resolve().parents[1]/"CoreGeek/src"))
import unittest
from agent.protocol import Pos,Unit,Robot,Turn
from agent.fire_control import targets,joint_railgun_targets,ray_hits
